  ...
  return (
    <div style={{ minHeight: '100dvh', backgroundColor: 'var(--color-canvas)' }}>
      ...
      <main style={{
        ...
        <Section title="Account Removal and Data Deletion">
          <p>
            You have full control over your data and your connection to FeeLedger. You can:
          </p>
          <ol>
            <li><strong>Delete all your data:</strong> Go to Settings → Account → Delete All Data inside the app. This deletes the FeeLedger folder from your Google Drive and clears all local data.</li>
            <li><strong>Delete the Drive folder manually:</strong> Open Google Drive, find the <strong>FeeLedger</strong> folder, and delete it. All your data is gone.</li>
            <li><strong>Revoke Google account access:</strong> Visit <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-link)' }}>myaccount.google.com/permissions</a> and remove FeeLedger. This prevents the app from accessing your Drive in future sessions.</li>
          </ol>
          <p>
            After revoking access, any data remaining in your Google Drive is still yours — FeeLedger simply
            can no longer access it. You can delete it manually from Google Drive at any time.
          </p>
          <p>
            FeeLedger has no account database to delete — we have no servers and store nothing about you.
            Revoking Google access and deleting your Drive folder is the complete removal process.
          </p>
        </Section>
