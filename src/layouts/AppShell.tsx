  ...
  const sidebarContent = (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '0 8px 24px' }}>
        ...
        <span style={{ color: 'var(--color-white)', fontWeight: 700, fontSize: 17, letterSpacing: '-0.02em' }}>
          FeeLedger
        </span>
      </div>
      ...
      >
        ...
        <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13, fontWeight: 450 }}>
          Synced to Drive
        </span>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ color: 'var(--color-white)', fontWeight: 700, fontSize: 16 }}>FeeLedger</span>
          </div>
          <button
